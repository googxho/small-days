...
import {Typography} from '@/component/rn-kuki-ui';
  ...
  return (
    <ScrollView>
      <DemoBlock title="基础用法" inset>
        <Typography.Text>
          In the process of{' '}
          <Typography.Text type="danger">internal</Typography.Text>{' '}
          <Typography.Text delete>desktop</Typography.Text>applications
          development,
          <Typography.Text type="primary"> many different</Typography.Text>{' '}
          design specs and{' '}
