...
import {Cell, ActionSheet, ActionSheetAction} from '@/component/rn-kuki-ui';
  ...
  return (
    <ScrollView>
      <DemoBlock title="基础用法">
        <Cell.Group inset>
          ...
          <Cell
            title="展示取消按钮"
            isLink
            onPress={() => onOpen({cancel: '取消'})}
          />
          <Cell
            title="展示描述信息"
            isLink
            onPress={() =>
              onOpen({desc: '这是一段描述信息', cancel: '取消', list: actions1})
            }
          />
        </Cell.Group>
      </DemoBlock>
      ...
      <ActionSheet
        ...
        <View>
          <Text
            style={{paddingHorizontal: 16, paddingTop: 16, paddingBottom: 160}}>
            内容
          </Text>
        </View>
      </ActionSheet>
