...
import {ActionBar} from '@/component/rn-kuki-ui';
  ...
  return (
    <ScrollView>
      ...
      <DemoBlock title="自定义图标颜色">
        <ActionBar>
          <ActionBar.Icon
            icon={<Icon name="chat-o" color="red" />}
            text="客服"
          />
          <ActionBar.Icon
            icon={<Icon name="cart-o" color="red" />}
            text="购物车"
          />
          <ActionBar.Icon
            icon={<Icon name="shop-o" color="red" />}
            text="店铺"
          />
          <ActionBar.Button type="warning" text="加入购物车" />
          <ActionBar.Button type="danger" text="立即购买" />
