...
const PopupDemo: FC = () => {
  ...
  const [closeIconPosition, setCloseIconPosition] =
    useState<PopupCloseIconPosition>();
      ...
      <DemoBlock title="弹出位置">
        <Cell.Group inset>
          <Cell
            title="顶部弹出"
            isLink
            onPress={() => onPress({side: 'top'})}
          />
          <Cell
            title="底部弹出"
            isLink
            onPress={() => onPress({side: 'bottom'})}
          />
          <Cell
            title="左侧弹出"
            isLink
            onPress={() => onPress({side: 'left'})}
          />
          <Cell
            title="右侧弹出"
            isLink
            onPress={() => onPress({side: 'right'})}
          />
        </Cell.Group>
      </DemoBlock>
