...
import {Badge} from '@/component/rn-kuki-ui';
  ...
  return (
    <ScrollView>
      ...
      <DemoBlock title="自定义徽标内容" contentStyle={styles.content} inset>
        <Badge
          content={<Icon name="success" size={12} color="#fff" />}
          style={styles.badge}>
          <View style={styles.child} />
        </Badge>
        <Badge
          content={<Icon name="cross" size={12} color="#fff" />}
          style={styles.badge}>
          <View style={styles.child} />
        </Badge>
        <Badge
          content={<Icon name="down" size={12} color="#fff" />}
          style={styles.badge}>
          <View style={styles.child} />
        </Badge>
      </DemoBlock>
