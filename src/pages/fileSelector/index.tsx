...
export default function FileSelector() {
  ...
  //               );
  //               if (
  //                 (await Promise.all(sdCardPaths.map(_ => exists(_)))).every(
  //                   val => val,
  //                 )
  //               ) {
  //                 setFilesData(
  ...
  //                 _ =>
  //                   _.isFile() &&
  //                   (matchExtension ? matchExtension(_.path) : true),
  //               )
  //               .map(_ => ({
  //                 type: 'file',
  //                 path: _.path,
  ...
  //           const newCheckedItem = prev.filter(_ => !itemPaths.includes(_.path));
  //           if (nextChecked) {
